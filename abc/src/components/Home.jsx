...
const Home = () => {
    ...
    const news = [
        {id: 1, title: 'Hydrogen VS Electric Cars', desc: 'Will hydrigen-fueled cars ever catch up to EVs?'},
        {id: 2, title: 'The Down Side of AI Artistry', desc: 'What are the possible adverse effects of on-demand AI image generations?'},
    ...
    return (
        <section className='w-full'>
            <div className={`flex justify-between items-center w-full`}>
                <div className={`flex justify-between items-center mx-auto w-[90%] lg:w-4/6`}>
